...
% Date: 10/13/2021
%-----------------------------------------
clear;clc;clf(figure(1));clf(figure(2));
...
plot(theta2,theta3_1,'m--','LineWidth',2); hold on;
plot(theta2,theta3_2,'m-','LineWidth',2); hold on;
%Plot y vs. x with magenta solid/dashed line and line width 2
plot(theta2,theta4_1,'c--','LineWidth',2); hold on;
plot(theta2,theta4_2,'c-','LineWidth',2); hold on;
%Label x and y axis
